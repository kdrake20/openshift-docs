...
See link:https://access.redhat.com/documentation/en-us/assisted_installer_for_openshift_container_platform/[Assisted Installer for OpenShift Container Platform] to install {product-title} on a single node.
